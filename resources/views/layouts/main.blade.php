<html>
    ...
    <div class="header">
	  <a href="/" class="logo">ProfileBook</a>
	  <div class="header-right">
		<a class="active" href="/">Home</a>
		@if( auth()->check() )
			@if(auth()->user()->role == 1)
			   <a class="nav-link font-weight-bold" href="/admin-dashboard">Admin Panel</a>
		    @else
				<a class="nav-link font-weight-bold" href="/user/{{ auth()->user()->id }}">Hi {{ auth()->user()->name }}</a>
			@endif
